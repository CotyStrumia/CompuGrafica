...
class Quad(Model):
    def __init__(self, position=(0,0,0), rotation=(0,0,0), scale=(1,1,1), name="quad", animated=True, hittable=True):
        ...
        self.__colision = HitBoxOBB(self.get_model_matrix, hittable=hittable)
        ...
        super().__init__(self.__vertices, indices, colors= colors, texcoords=texcoords, normals=normals)
