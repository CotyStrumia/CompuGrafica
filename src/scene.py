...
class RaySceneGPU(Scene):
    def __init__(self, ctx, width, height, camera, output_model, output_material):
        self.ctx = ctx
        self.camera = camera
        self.width = width
        self.height = height
    ...
    def start(self):
        ...
        self.mats_f = np.zeros((n, 4), dtype='f4') # r, g, b, reflectivity
    ...
    def _update_matrix(self):
        ...
        for i, (name, graphics) in enumerate(self.graphics.items()):
           ...
           graphics.create_materials_matrix(self.mats_f, i)
